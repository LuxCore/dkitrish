...
public class DoctorTest {
	 ...
	 * Имя доктора.
	 */
	private Name strange = new Name("Strange");

	/**
	 * Внеземное образование доктора Стрейнджа.
	 */
	private Education extraterrestrialEdu = new Education("Астрал", "Красный");
	 ...
	 * Профессия доктора.
	 */
	private Doctor doctorStrange = new Doctor(strange, extraterrestrialEdu, oneMonth);

	/**
	 * Patient Xander Cage.
	 */
	private Patient xanderCage = new Patient(new Name("Ксандер", "Кейдж"));
